...
public interface japyListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link japyParser#elseclose}.
	 * @param ctx the parse tree
	 */
	void enterElseclose(japyParser.ElsecloseContext ctx);
	/**
	 * Exit a parse tree produced by {@link japyParser#elseclose}.
	 * @param ctx the parse tree
	 */
	void exitElseclose(japyParser.ElsecloseContext ctx);
	/**
	 * Enter a parse tree produced by {@link japyParser#if}.
	 * @param ctx the parse tree
	 */
	void enterIf(japyParser.IfContext ctx);
	/**
	 * Exit a parse tree produced by {@link japyParser#if}.
	 * @param ctx the parse tree
	 */
	void exitIf(japyParser.IfContext ctx);
	/**
	 * Enter a parse tree produced by {@link japyParser#elif}.
	 * @param ctx the parse tree
	 */
	void enterElif(japyParser.ElifContext ctx);
	/**
	 * Exit a parse tree produced by {@link japyParser#elif}.
	 * @param ctx the parse tree
	 */
	void exitElif(japyParser.ElifContext ctx);
	/**
	 * Enter a parse tree produced by {@link japyParser#else}.
	 * @param ctx the parse tree
	 */
	void enterElse(japyParser.ElseContext ctx);
	/**
	 * Exit a parse tree produced by {@link japyParser#else}.
	 * @param ctx the parse tree
	 */
	void exitElse(japyParser.ElseContext ctx);
	/**
