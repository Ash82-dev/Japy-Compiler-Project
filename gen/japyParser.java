// Generated from V:/University/Term 5/Compiler Design/Final Project/grammar/japy.g4 by ANTLR 4.13.1
...
public class japyParser extends Parser {
	...
	public static final int
		...
		RULE_closedStatement = 6, RULE_closedConditional = 7, RULE_elseclose = 8, 
		RULE_if = 9, RULE_elif = 10, RULE_else = 11, RULE_openConditional = 12, 
		RULE_openStatement = 13, RULE_statement = 14, RULE_statementVarDef = 15, 
		RULE_statementBlock = 16, RULE_statementContinue = 17, RULE_statementBreak = 18, 
		RULE_statementReturn = 19, RULE_statementClosedLoop = 20, RULE_statementOpenLoop = 21, 
		RULE_statementWrite = 22, RULE_statementAssignment = 23, RULE_statementInc = 24, 
		RULE_statementDec = 25, RULE_expression = 26, RULE_expressionOr = 27, 
		RULE_expressionOrTemp = 28, RULE_expressionAnd = 29, RULE_expressionAndTemp = 30, 
		RULE_expressionEq = 31, RULE_expressionEqTemp = 32, RULE_expressionCmp = 33, 
		RULE_expressionCmpTemp = 34, RULE_expressionAdd = 35, RULE_expressionAddTemp = 36, 
		RULE_expressionMultMod = 37, RULE_expressionMultModTemp = 38, RULE_expressionUnary = 39, 
		RULE_expressionMethods = 40, RULE_expressionMethodsTemp = 41, RULE_expressionOther = 42, 
		RULE_japyType = 43, RULE_singleType = 44;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"elseclose", "if", "elif", "else", "openConditional", "openStatement", 
			"statement", "statementVarDef", "statementBlock", "statementContinue", 
			"statementBreak", "statementReturn", "statementClosedLoop", "statementOpenLoop", 
			"statementWrite", "statementAssignment", "statementInc", "statementDec", 
			"expression", "expressionOr", "expressionOrTemp", "expressionAnd", "expressionAndTemp", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"')'", "'returns'", "'else'", "'if'", "'elif'", "'var'", "'='", "'continue'", 
	...
	public final MethodDeclarationContext methodDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 12517424551825416L) != 0)) {
				{
				{
				setState(166);
	...
	public static class ClosedConditionalContext extends ParserRuleContext {
		...
		public ElsecloseContext elseclose() {
			return getRuleContext(ElsecloseContext.class,0);
		}
	...
	@SuppressWarnings("CheckReturnValue")
	public static class ElsecloseContext extends ParserRuleContext {
		...
		public ElsecloseContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_elseclose; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof japyListener ) ((japyListener)listener).enterElseclose(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof japyListener ) ((japyListener)listener).exitElseclose(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof japyVisitor ) return ((japyVisitor<? extends T>)visitor).visitElseclose(this);
			else return visitor.visitChildren(this);
		}
	}

	public final ElsecloseContext elseclose() throws RecognitionException {
		ElsecloseContext _localctx = new ElsecloseContext(_ctx, getState());
		enterRule(_localctx, 16, RULE_elseclose);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(196);
			match(T__15);
			setState(197);
			((ElsecloseContext)_localctx).elseStmt = closedStatement();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static class IfContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof japyListener ) ((japyListener)listener).enterIf(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof japyListener ) ((japyListener)listener).exitIf(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof japyVisitor ) return ((japyVisitor<? extends T>)visitor).visitIf(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final IfContext if_() throws RecognitionException {
		...
		try {
			...
			match(T__11);
			setState(201);
			((IfContext)_localctx).ifExp = expression();
			setState(202);
			match(T__13);
			setState(203);
			((IfContext)_localctx).thirdIfStat = closedStatement();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static class ElifContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof japyListener ) ((japyListener)listener).enterElif(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof japyListener ) ((japyListener)listener).exitElif(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof japyVisitor ) return ((japyVisitor<? extends T>)visitor).visitElif(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final ElifContext elif() throws RecognitionException {
		...
		try {
			...
			match(T__11);
			setState(207);
			((ElifContext)_localctx).elifExp = expression();
			setState(208);
			match(T__13);
			setState(209);
			((ElifContext)_localctx).elifStat = closedStatement();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static class ElseContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof japyListener ) ((japyListener)listener).enterElse(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof japyListener ) ((japyListener)listener).exitElse(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof japyVisitor ) return ((japyVisitor<? extends T>)visitor).visitElse(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final ElseContext else_() throws RecognitionException {
		...
		try {
			...
			match(T__15);
			setState(212);
			((ElseContext)_localctx).elseStmt = openStatement();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OpenConditionalContext openConditional() throws RecognitionException {
		...
		enterRule(_localctx, 24, RULE_openConditional);
		int _la;
		try {
			int _alt;
			setState(233);
	...
	public final OpenStatementContext openStatement() throws RecognitionException {
		...
		enterRule(_localctx, 26, RULE_openStatement);
		try {
			setState(237);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final StatementVarDefContext statementVarDef() throws RecognitionException {
		...
		enterRule(_localctx, 30, RULE_statementVarDef);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final StatementContinueContext statementContinue() throws RecognitionException {
		...
		enterRule(_localctx, 34, RULE_statementContinue);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(265);
	...
	public final StatementBreakContext statementBreak() throws RecognitionException {
		...
		enterRule(_localctx, 36, RULE_statementBreak);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(267);
	...
	public final StatementReturnContext statementReturn() throws RecognitionException {
		...
		enterRule(_localctx, 38, RULE_statementReturn);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(269);
	...
	public final StatementClosedLoopContext statementClosedLoop() throws RecognitionException {
		...
		enterRule(_localctx, 40, RULE_statementClosedLoop);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(272);
	...
	public final StatementOpenLoopContext statementOpenLoop() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_statementOpenLoop);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(278);
	...
	public final StatementWriteContext statementWrite() throws RecognitionException {
		...
		enterRule(_localctx, 44, RULE_statementWrite);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(284);
	...
	public final StatementAssignmentContext statementAssignment() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_statementAssignment);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(289);
	...
	public final StatementIncContext statementInc() throws RecognitionException {
		...
		enterRule(_localctx, 48, RULE_statementInc);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(293);
	...
	public final StatementDecContext statementDec() throws RecognitionException {
		...
		enterRule(_localctx, 50, RULE_statementDec);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(296);
	...
	public final ExpressionOrContext expressionOr() throws RecognitionException {
		...
		enterRule(_localctx, 54, RULE_expressionOr);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(301);
	...
	public final ExpressionOrTempContext expressionOrTemp() throws RecognitionException {
		...
		enterRule(_localctx, 56, RULE_expressionOrTemp);
		try {
			setState(309);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final ExpressionAndContext expressionAnd() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_expressionAnd);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(311);
	...
	public final ExpressionAndTempContext expressionAndTemp() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_expressionAndTemp);
		try {
			setState(319);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final ExpressionEqContext expressionEq() throws RecognitionException {
		...
		enterRule(_localctx, 62, RULE_expressionEq);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(321);
	...
	public final ExpressionEqTempContext expressionEqTemp() throws RecognitionException {
		...
		enterRule(_localctx, 64, RULE_expressionEqTemp);
		try {
			setState(332);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final ExpressionCmpContext expressionCmp() throws RecognitionException {
		...
		enterRule(_localctx, 66, RULE_expressionCmp);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(334);
	...
	public final ExpressionCmpTempContext expressionCmpTemp() throws RecognitionException {
		...
		enterRule(_localctx, 68, RULE_expressionCmpTemp);
		try {
			setState(345);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final ExpressionAddContext expressionAdd() throws RecognitionException {
		...
		enterRule(_localctx, 70, RULE_expressionAdd);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(347);
	...
	public final ExpressionAddTempContext expressionAddTemp() throws RecognitionException {
		...
		enterRule(_localctx, 72, RULE_expressionAddTemp);
		try {
			setState(358);
			_errHandler.sync(this);
	...
	public final ExpressionMultModContext expressionMultMod() throws RecognitionException {
		...
		enterRule(_localctx, 74, RULE_expressionMultMod);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(360);
	...
	public final ExpressionMultModTempContext expressionMultModTemp() throws RecognitionException {
		...
		enterRule(_localctx, 76, RULE_expressionMultModTemp);
		try {
			setState(372);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final ExpressionUnaryContext expressionUnary() throws RecognitionException {
		...
		enterRule(_localctx, 78, RULE_expressionUnary);
		try {
			setState(380);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final ExpressionMethodsContext expressionMethods() throws RecognitionException {
		...
		enterRule(_localctx, 80, RULE_expressionMethods);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(382);
	...
	public final ExpressionMethodsTempContext expressionMethodsTemp() throws RecognitionException {
		...
		enterRule(_localctx, 82, RULE_expressionMethodsTemp);
		int _la;
		try {
			setState(409);
			_errHandler.sync(this);
	...
	public final ExpressionOtherContext expressionOther() throws RecognitionException {
		...
		enterRule(_localctx, 84, RULE_expressionOther);
		int _la;
		try {
			setState(449);
			_errHandler.sync(this);
	...
	public final JapyTypeContext japyType() throws RecognitionException {
		...
		enterRule(_localctx, 86, RULE_japyType);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final SingleTypeContext singleType() throws RecognitionException {
		...
		enterRule(_localctx, 88, RULE_singleType);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(460);
