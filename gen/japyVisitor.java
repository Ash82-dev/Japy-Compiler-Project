...
public interface japyVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link japyParser#elseclose}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitElseclose(japyParser.ElsecloseContext ctx);
	/**
	 * Visit a parse tree produced by {@link japyParser#if}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIf(japyParser.IfContext ctx);
	/**
	 * Visit a parse tree produced by {@link japyParser#elif}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitElif(japyParser.ElifContext ctx);
	/**
	 * Visit a parse tree produced by {@link japyParser#else}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitElse(japyParser.ElseContext ctx);
	/**
